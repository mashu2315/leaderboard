...
// const Background = () => {
//   return (
//     <div className="trading-background fixed inset-0 overflow-hidden pointer-events-none z-0">
//       <svg className="chart" viewBox="0 0 1000 400" preserveAspectRatio="none">
//         {/* Light grid lines */}
//         {[...Array(10)].map((_, i) => (
//           <line
//             key={`h-${i}`}
